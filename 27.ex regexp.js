...
console.log(str1.match(/[0-9]{1,4}/g));
...
console.log(text1.match(/[a-zA-Z]{4}s?:\/\/[a-zA-Z]+.[a-zA-Z]+/g));
console.log(text1.match(/https?:\/\/[^\s]+/g)); //공백이 아닌것
...
console.log(text2.match(/\d{1,}\.\d{2}/g));

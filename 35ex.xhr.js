...
//     } else {
//         console.error('에러발생!', xhr.status, xhr.statusText); //error말고 log로 써도됨
//     }
// };
...
const xhrUtil = {
    ...
    init: (httpMethod, url, payload) => {
        ...
        // 요청 전송
        xhr.send(payload); //인자로 들어가는게 response body (get이면 비어있음)
    }
};
...
// xhrUtil.init('GET', 'https://jsonplaceholder.typicode.com/photos', '?id=5001');

// put : 한건 전체 수정
// xhrUtil.init('PUT', 'https://jsonplaceholder.typicode.com/photos/1',
//     '{"albumId":1, "id":1, "title":"mod_title1", "url":mod_url1", "thumbnailUrl":"mod_thumnailUrl1"}'
// );

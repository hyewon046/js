...
//     // Promise를 리턴
//     // Promise는 콜백함수에 성공시애 수행할 resolve함수와
...
// //내가한거
// const promisePatch = (url, payload) => {
//     return new Promise((resolve, reject) => {
//         const xhr = new XMLHttpRequest();
//         xhr.open('PATCH', url);
//         xhr.setRequestHeader('content-type', 'application/json');
...
//     });
// };
// promisePatch('https://jsonplaceholder.typicode.com/posts/20', 
//     '{"title":"modifiedtitle"}'
// )
...
// //내가한거
// const promiseList = (url, payload) => {
//     return new Promise((resolve, reject) => {
//         const xhr = new XMLHttpRequest();
//         url = url + (payload ? payload : '');
//         xhr.open('GET', url);
//         xhr.setRequestHeader('content-type', 'aspplication/json');
//         xhr.send(payload);
//         xhr.onload = () => {
//             if (xhr.status === 200 || xhr.status === 201) {
//                 resolve(JSON.parse(xhr.response));
...
//     });
// };
// promiseList('https://jsonplaceholder.typicode.com/comments', 
//     '?postId=3'
// )
// .then(res => console.log(res))
// .catch(err => console.log(err))
...
// //3을 배열에 담고 배열 출력
// .then(data => { res.push(data); console.log(res); }) //총 6초후에 출력
// .catch(console.error)
...
// // 전체가 다 resolve되거나 reject되면 수행을 종료
// /*
//     (3) [{…}, {…}, {…}]
...
// fetch
// 프라미스를 반환하는 비동기처리를 위한 WEB API (웹브라우저에서 동작)
...
request.post('https://jsonplaceholder.typicode.com/todos', 
    {userId:1, title:'Javascript', completed:false}) //id는 안적었는데 자동부여됨
.then(response => response.json())
.then(todos => console.log(todos))
.catch(err => console.error(err))
...
request.put('https://jsonplaceholder.typicode.com/todos/1', 
    {userId:1, title:'React', completed:true})
.then(response => response.json())
.then(todos => console.log(todos))
.catch(err => console.error(err))

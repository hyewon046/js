...
const add = function(a,b) {
    ...
    console.log(add.caller); //[Function (anonymous)] (호출함)
    console.log(arguments.callee); //[Function: add] (호출당함)
...
console.log(person.hasOwnProperty('name')); //true (우리가 만든것)
console.log(person.hasOwnProperty('age')); //true (우리가 만든것)
console.log(person.hasOwnProperty('__proto__')); //false

const obj = {};
console.log(obj.__proto__ === Object.prototype); //true (모든 객체는 만들어지면 __proto__ 가 있음, 이게 가리키는 것은 상위객체의 프로토타입)

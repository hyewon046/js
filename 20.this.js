...
// Car는 함수일뿐, 호출시점에 생성자함수, 메소드, 일반함수인지가 결정됨
const Car = function() {
    console.log(this);
};
...
// bind : this를 함수 호출시 전에 바인딩, this바인딩된 함수를 반환
funcnew = func.bind(person);
funcnew(); //홍길동 undefined NaN
const person2 = {name: '강감찬'};
funcnew2 = func.bind(person2);
funcnew2(); // 강감찬 undefined NaN (위에 person만들어서 age넣어도 파라미터로 넣은게 아니라서 undefined라고 뜸)

// 정규표현식 객체 생성
const regExp = /abc/i; //대소문자 구별 없이 a가 오고 b가 오고 c가 오는 패턴
...
console.log(str.match(regExp4)); //[ 'ab', 'ab', 'ab' ], 매칭되는 것 배열로 반환
console.log(str.replace(/abc/, '')); //ab  ab, 패턴에 일치하는 문자열 대체

// 패턴 문자
const str2 = 'a ab aa abc aaa ac abcd';
// . : 문자 하나
console.log(str2.match(/a./g)); //['a ','ab','aa','ab','aa','a ','ac','ab'], 공백도 문자임
// {} : 반복횟수
...
console.log(str2.match(/[a-zA-Z_]/g));//워드(영문자 또는 _) 하나, =\w
/*[
    'a', 'a', 'b', 'a', 'a',
    'a', 'b', 'c', 'a', 'a',
    'a', 'a', 'c', 'a', 'b',

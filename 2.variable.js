/*
    리터럴(literal) : 코드에 쓰인 값
                     ...
                     리터럴은 해석(parsing)될 때 값으로 평가됨(evaluation)
...
// 선언 : 변수명만 알 수 있음, 초기화하지 않으면 undefined로 초기화
let l2; 
console.log(l2); // undefined로 자동 초기화 됨(선언할때말고 실행할때), 타입은 undefined
...
// const c2; // SyntaxError, 상수는 반드시 초기화해야 함

...
// 프로토타입 확장
Person.prototype.getAge = function() {  //그림기준 Person.prototype에는 getAge function이 있고, Person에는 getName function이 있게됨
    return this.age;
};
...
console.log(person1.__proto__ == person2.__proto__); //true (둘다 person.prototype을 가리킴)

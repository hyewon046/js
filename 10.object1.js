// 객체참조변수는 const로 선언!
const obj1 = {}; //변수이름은 불변, 프라퍼티 안의 값은 가변
...
console.log(o4 instanceof Person);
console.log(o4 instanceof Object);
...
// hong.first-name = '길동'; //Syntax Error
hong['first-name'] = '길동';
console.log(hong);
